...
var binaryUtil = function () {
  ...
  _createClass(binaryUtil, [{
    ...
    key: 'byteArrayToLong',
    value: function byteArrayToLong(byteArray) {
      var value = 0;
    ...
    key: 'bytesFromHex',
    value: function bytesFromHex(str, pad) {
    ...
    key: 'jsIntToBytes',
    value: function jsIntToBytes(v, f) {
      var c = 0;
    ...
    key: 'jsIntTo4Bytes',
    value: function jsIntTo4Bytes(v, f) {
      if (v < 0) {
        f(null);
        return;
      }
      ...
      // 8 bytes ---> 4 bytes
      this.jsIntToBytes(v, function (res) {
    ...
    key: 'bytesToJsInt',
    value: function bytesToJsInt(bytes) {
    ...
    key: 'readMessage',
    value: function readMessage(arrayBuffer, readCallback) {
    ...
    key: 'dispatchMessage',
    value: function dispatchMessage(messageType, bytes, callback) {
    ...
    key: 'typeKEEP',
    value: function typeKEEP(messageType, bytes, keepCallback) {
    ...
    key: 'typeARGB',
    value: function typeARGB(messageType, bytes, argbCallback) {
    ...
    key: 'canvasImageData',
    value: function canvasImageData(canvas, x, y, imageWidth, imageHeight, bytes) {
    ...
    key: 'makeKEEP',
    value: function makeKEEP(callback) {
      ...
      try {
        ...
        var bytesToJsInt = this.bytesToJsInt;
        this.jsIntToBytes(0, function (res) {
    ...
    key: 'makeUTF8',
    value: function makeUTF8(str, utf8Callback) {
      if (!str || str === '') {
      ...
      try {
        ...
        this.jsIntToBytes(baDataLen, function (res) {
    ...
    key: 'make0001',
    value: function make0001(callback) {
    ...
    key: 'makeARGB',
    value: function makeARGB(canvas, x, y, callback) {
      var cb = callback;
      try {
        var ctx = canvas.getContext('2d');
        ...
        var jsIntTo4Bytes = this.jsIntTo4Bytes;
        var jsIntToBytes = this.jsIntToBytes;
        var bytesToJsInt = this.bytesToJsInt;

        this.jsIntTo4Bytes(width, function (widthBytes) {
          // byte array representation of width
          // ===> get height's too
          jsIntTo4Bytes(height, function (heightBytes) {
